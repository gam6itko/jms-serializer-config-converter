...
class BlogPost
{
    ...
    /**
     * @Type("ArrayCollection<Gam6itko\JSCC\Tests\Fixtures\Comment>")
    ...
    /**
     * @Type("array<Gam6itko\JSCC\Tests\Fixtures\Comment>")
    ...
    /**
     * @Type("Gam6itko\JSCC\Tests\Fixtures\Author")
     * @Groups({"post"})
    ...
    /**
     * @Type("Gam6itko\JSCC\Tests\Fixtures\Publisher")
     */
    private $publisher;

    /**
     * @Type("array<Gam6itko\JSCC\Tests\Fixtures\Tag>")
