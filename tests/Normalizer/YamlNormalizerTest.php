 ...
 *
 * @coversDefaultClass \Gam6itko\JSCC\Normalizer\YamlNormalizer
 */
...
//        $vp2->expose = true;
        ...
        //<editor-fold desc="case">
        $config = new ClassConfig('Gam6itko\JSCC\Tests\Fixtures\BlogPost');
        $config->xmlRootName = 'blog-post';
        $config->xmlNamespaces = [
        ...
        $prop->type = 'DateTime';
        $prop->xmlAttribute = true;
        $config->properties['createdAt'] = $prop;
        $prop = new PropertyConfig();
        $prop->name = 'published';
        $prop->type = 'boolean';
        $prop->serializedName = 'is_published';
        $prop->xmlAttribute = true;
        $prop->groups = ['post'];
        $config->properties['published'] = $prop;
        $prop = new PropertyConfig();
        $prop->name = 'etag';
        $prop->type = 'string';
        $prop->groups = ['post'];
        ...
        $prop->xmlElement = $xmlElement;
        $config->properties['etag'] = $prop;
        $prop = new PropertyConfig();
        $prop->name = 'comments';
        $prop->type = 'ArrayCollection<Gam6itko\JSCC\Tests\Fixtures\Comment>';
        $prop->groups = ['comments'];
        $xmlList = new XmlListConfig();
        $xmlList->inline = true;
        $xmlList->entryName = 'comment';
        $prop->xmlList = $xmlList;
        $config->properties['comments'] = $prop;
        $prop = new PropertyConfig();
        $prop->name = 'author';
        $prop->type = 'Gam6itko\JSCC\Tests\Fixtures\Author';
        $prop->groups = ['post'];
        $xmlElement = new XmlElementConfig();
        $xmlElement->namespace = 'http://www.w3.org/2005/Atom';
        $prop->xmlElement = $xmlElement;
        $config->properties['author'] = $prop;
        yield [
